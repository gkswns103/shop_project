    ...
    <div class="container mt-5">
		...
		<!-- 	 <div class="form-group row align-items-center">
			    ...
			    <div class="col-sm-8">
			        ...
			        <div class="d-flex">
			            <button type="button" class="btn btn-primary me-2" onclick="document.getElementById('imageFile').click();">이미지 등록</button>
				 ...
				 <div class="form-group row">
                <label for="explain" class="col-sm-2 col-form-label">filepath</label>
                <div class="col-sm-8">
