	...
	<form>
		...
		<div class="id">
			<div class="base">
				...
				<input type="button" id="toggleButton" style="margin-top:10px;" value="아이디 변경" onclick="toggleChange_id();">
			</div>
		...
		<div class="email">
			<div class="base">
				...
				<input type="button" id="toggle_e" style="margin-top:10px;" value="이메일 변경"onclick="toggleChange_email();">
			</div>
